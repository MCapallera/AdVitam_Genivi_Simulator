...
public class SteeringWheelInputController : InputController {
	...
	//Button SteeringWheel (Quentin)
	private int autoPathButton = 0;
	private bool activateAutoPilot = false;
	...
	public override void OnUpdate()
	{
...

		{
			...
			//Quentin
			autoPathButton = (int)state.rgbButtons [6]; 

			if ((autoPathButton == 128 || accelInput<0) && buttonPressed == false) 
			{
				activateAutoPilot = true;
				buttonPressed = true;
			} 
			else if ((autoPathButton == 128 || accelInput<0)  && buttonPressed == true) 
			{
	...
	//Quentin
	public override bool GetStateAutoPathButton()
	{
